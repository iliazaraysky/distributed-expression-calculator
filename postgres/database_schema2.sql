...
--
-- Name: user; Type: TABLE; Schema: public; Owner: calculator_db_user
--
...
ALTER TABLE public."user" OWNER TO calculator_db_user;

--
-- Name: user_id_seq; Type: SEQUENCE; Schema: public; Owner: calculator_db_user
--
...
ALTER SEQUENCE public.user_id_seq OWNER TO calculator_db_user;

--
-- Name: user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: calculator_db_user
--
...
--
-- Name: user id; Type: DEFAULT; Schema: public; Owner: calculator_db_user
--
...
4	9e395bbc-b128-45a9-98ed-2c1122b41516	2 + 4	2024-04-03 18:20:54.313717+00	2024-04-03 18:21:04.36364+00	worker1	6	00:00:10.049923	Done
\.


--
-- Data for Name: user; Type: TABLE DATA; Schema: public; Owner: calculator_db_user
--

COPY public."user" (id, username, password, email, creted_at, updated_at) FROM stdin;
\.
...
1	worker1	2024-04-03 18:21:26.30913+00	ready	9e395bbc-b128-45a9-98ed-2c1122b41516	20
\.
...
--
-- Name: user_id_seq; Type: SEQUENCE SET; Schema: public; Owner: calculator_db_user
--
...
--
-- Name: user user_pkey; Type: CONSTRAINT; Schema: public; Owner: calculator_db_user
--
...
--
-- Name: user user_username_key; Type: CONSTRAINT; Schema: public; Owner: calculator_db_user
--
